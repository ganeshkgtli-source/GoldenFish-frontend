...
//   };
 const navItems = [
  ...
  { label: "Portfolio", icon: Briefcase, to: "/client/Portfolio" },
  { label: "Positions", icon: BarChart3, to: "/client/Postitions" },
  { label: "Orders", icon: FileText, to: "/client/orders" },
  { label: "Money", icon: Wallet, to: "/client/Money" },
];
